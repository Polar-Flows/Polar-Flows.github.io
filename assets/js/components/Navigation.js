...
export class Navigation {
  ...
  async init() {
    try {
      ...
      // Navigation component initialized (debug logging disabled)
  ...
  async waitForElements() {
    ...
    while (attempts < maxAttempts) {
      ...
      if (this.navbar && this.navbarToggle) {
        ...
        if (!this.navbarNav) {
          // Navigation component: No navbar-nav found, skipping navigation setup
          return;
        }
    ...
    if (!this.navbar) {
      // Navigation component: No navbar found, skipping navigation initialization
      return;
    }
  ...
  setupEventListeners() {
    ...
    if (!this.navbar) {
      // Navigation component: No navbar found, skipping event listener setup
      return;
    }
    ...
    if (this.navbarToggle) {
      if (this.navbarToggle.classList.contains('navbar-back-home')) {
        ...
        // Back to home button found, navigation handled by onclick
      } else {
        // Mobile menu toggle
  ...
  setupKeyboardNavigation() {
    ...
    if (!this.navbarNav) {
      // Navigation component: No navbar-nav found, skipping keyboard navigation setup
      return;
    }
  ...
  destroy() {
    ...
    // Navigation component destroyed
  }
}
