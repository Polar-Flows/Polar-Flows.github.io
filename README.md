...
## CRITICAL: CSS/JS Versioning Required
...
1. Increment version number (e.g., `v1.2.23` to `v1.2.24`)
...
**Example**: `<link rel="stylesheet" href="assets/css/main.css?v=1.2.23">`
...
**Implementation**: See `WEBSITE_SUMMARY.md` for technical details.
